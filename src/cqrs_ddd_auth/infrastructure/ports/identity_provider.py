...
class IdentityProviderPort(Protocol):
    ...
    def requires_otp(self, claims: UserClaims) -> bool:
        """
        Check if the IdP requires OTP for this user based on claims.

        Note: This is often detected via specific claims like 'otp_required'
        or by checking if specific MFA-related claims are missing.
        """
        ...
