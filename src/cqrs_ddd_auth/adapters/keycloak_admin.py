...
class UserManagementError(Exception):
    ...
    def __init__(self, message: str, error_code: str = "USER_MANAGEMENT_ERROR"):
...
class KeycloakAdminAdapter:
        ...
        try:
            ...
            for user in users:
                ...
                if filters and filters.group:
                    ...
                    if not any(g.name == filters.group or g.group_id == filters.group for g in user_groups):
                        continue
    ...
    def _map_user(self, kc_user: dict[str, Any]) -> UserData:
        ...
        return UserData(
            ...
            created_at=str(kc_user.get("createdTimestamp", "")) if kc_user.get("createdTimestamp") else None,
